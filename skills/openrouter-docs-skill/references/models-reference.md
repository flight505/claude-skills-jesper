...
- **Pricing:** $0.000004/1M prompt, $N/A/1M completion
...
- **Description:** Tongyi DeepResearch is an agentic large language model developed by Tongyi Lab, with 30 billion total parameters activating only 3 billion per token. It's optimized for long-horizon, deep information-...
...
- **Pricing:** $0.000000035/1M prompt, $N/A/1M completion
...
- **Context:** 200,000 tokens
- **Pricing:** $0.000015/1M prompt, $N/A/1M completion
...
- **Context:** 131,072 tokens
- **Pricing:** $0.0000009/1M prompt, $N/A/1M completion
...
- **Context:** 131,072 tokens
- **Pricing:** $0.000000045/1M prompt, $N/A/1M completion
- **Description:** Trinity Mini is a 26B-parameter (3B active) sparse mixture-of-experts language model featuring 128 experts with 8 active per token. Engineered for efficient reasoning over long contexts (131k) with ro...
...
- **Context:** 128,000 tokens
- **Pricing:** $0.0000000375/1M prompt, $N/A/1M completion
...
- **Context:** 163,840 tokens
- **Pricing:** $0.00000027/1M prompt, $N/A/1M completion
...
- **Context:** 131,072 tokens
- **Pricing:** $0.000000252/1M prompt, $N/A/1M completion
...
- **Context:** 1,048,576 tokens
- **Pricing:** $0.000000435/1M prompt, $N/A/1M completion
...
- **Context:** 32,768 tokens
- **Pricing:** $0.00000015/1M prompt, $N/A/1M completion
- **Description:** Rnj-1 is an 8B-parameter, dense, open-weight model family developed by Essential AI and trained from scratch with a focus on programming, math, and scientific reasoning. The model demonstrates strong ...
...
- **Pricing:** $0.00000065/1M prompt, $N/A/1M completion
...
- **Pricing:** $0.000000017/1M prompt, $N/A/1M completion
...
- **Context:** 32,768 tokens
- **Pricing:** $0/1M prompt, $N/A/1M completion
- **Description:** LFM2.5-1.2B-Instruct is a compact, high-performance instruction-tuned model built for fast on-device AI. It delivers strong chat quality in a 1.2B parameter footprint, with efficient edge inference an...

#### LiquidAI: LFM2.5-1.2B-Thinking (free)
- **ID:** `liquid/lfm-2.5-1.2b-thinking:free`
- **Context:** 32,768 tokens
- **Pricing:** $0/1M prompt, $N/A/1M completion
- **Description:** LFM2.5-1.2B-Thinking is a lightweight reasoning-focused model optimized for agentic tasks, data extraction, and RAG—while still running comfortably on edge devices. It supports long context (up to 32K...
...
- **Context:** 8,192 tokens
- **Pricing:** $0.00000051/1M prompt, $N/A/1M completion
...
- **Context:** 131,072 tokens
- **Pricing:** $0.000000245/1M prompt, $N/A/1M completion
...
- **Pricing:** $0.000000065/1M prompt, $N/A/1M completion
...
- **Context:** 131,072 tokens
- **Pricing:** $0.000002/1M prompt, $N/A/1M completion
- **Description:** Mistral Large 2 2411 is an update of [Mistral Large 2](/mistralai/mistral-large) released together with [Pixtral Large 2411](/mistralai/pixtral-large-2411) It provides a significant upgrade on the pre...
...
- **Context:** 131,072 tokens
- **Pricing:** $0.00000057/1M prompt, $N/A/1M completion
...
- **Context:** 131,072 tokens
- **Pricing:** $0.000000135/1M prompt, $N/A/1M completion
- **Description:** DeepSeek V3.1 Nex-N1 is the flagship release of the Nex-N1 series — a post-trained model designed to highlight agent autonomy, tool use, and real-world productivity. Nex-N1 demonstrates competitive pe...
...
- **Context:** 131,072 tokens
- **Pricing:** $0.0000001/1M prompt, $N/A/1M completion
- **Description:** Llama-3.3-Nemotron-Super-49B-v1.5 is a 49B-parameter, English-centric reasoning/chat model derived from Meta’s Llama-3.3-70B-Instruct with a 128K context. It’s post-trained for agentic workflows (RAG,...
...
- **Context:** 128,000 tokens
- **Pricing:** $0.00001/1M prompt, $N/A/1M completion
...
- **Context:** 400,000 tokens
- **Pricing:** $0.00000125/1M prompt, $N/A/1M completion
- **Description:** GPT-5-Codex is a specialized version of GPT-5 optimized for software engineering and coding workflows. It is designed for both interactive development sessions and long, independent execution of compl...
...
- **Context:** 128,000 tokens
- **Pricing:** $0.00000125/1M prompt, $N/A/1M completion
- **Description:** GPT-5.1 Chat (AKA Instant is the fast, lightweight member of the 5.1 family, optimized for low-latency chat while retaining strong general intelligence. It uses adaptive reasoning to selectively “thin...
...
- **ID:** `openai/gpt-5.2`
- **Context:** 400,000 tokens
- **Pricing:** $0.00000175/1M prompt, $N/A/1M completion
...
- **Context:** 400,000 tokens
- **Pricing:** $0.000021/1M prompt, $N/A/1M completion
...
- **Context:** 128,000 tokens
- **Pricing:** $0.00000175/1M prompt, $N/A/1M completion
- **Description:** GPT-5.3 Chat is an update to ChatGPT's most-used model that makes everyday conversations smoother, more useful, and more directly helpful. It delivers more accurate answers with better contextualizati...
...
- **Pricing:** $0.000008/1M prompt, $N/A/1M completion
...
- **Context:** 131,072 tokens
- **Pricing:** $0.000000039/1M prompt, $N/A/1M completion
...
- **ID:** `openai/o1-pro`
- **Context:** 200,000 tokens
- **Pricing:** $0.00015/1M prompt, $N/A/1M completion
...
- **ID:** `openai/o3-mini`
- **Context:** 200,000 tokens
- **Pricing:** $0.0000011/1M prompt, $N/A/1M completion
...
- **ID:** `openai/o3-pro`
- **Context:** 200,000 tokens
- **Pricing:** $0.00002/1M prompt, $N/A/1M completion
...
Note: This model always uses the 'web_search' tool which adds addi...
...
- **Context:** 1,048,756 tokens
- **Pricing:** $0/1M prompt, $N/A/1M completion
- **Description:** Owl Alpha is a high-performance foundation model designed for agentic workloads. Natively supports tool use, and long-context tasks, with strong performance in code generation, automated workflows, an...
...
- **Context:** 131,072 tokens
- **Pricing:** $0/1M prompt, $N/A/1M completion
- **Description:** Laguna M.1 is the flagship coding agent model from [Poolside](https://poolside.ai), optimized for complex software engineering tasks. Designed for agentic coding workflows, it supports tool calling an...

#### Poolside: Laguna XS.2 (free)
- **ID:** `poolside/laguna-xs.2:free`
- **Context:** 131,072 tokens
- **Pricing:** $0/1M prompt, $N/A/1M completion
- **Description:** Laguna XS.2 is the second-generation model in the XS size class from [Poolside](https://poolside.ai), their efficient coding agent series. It combines tool calling and reasoning capabilities with a co...
...
- **Context:** 131,072 tokens
- **Pricing:** $0.0000002/1M prompt, $N/A/1M completion
- **Description:** INTELLECT-3 is a 106B-parameter Mixture-of-Experts model (12B active) post-trained from GLM-4.5-Air-Base using supervised fine-tuning (SFT) followed by large-scale reinforcement learning (RL). It offe...
...
- **Context:** 131,072 tokens
- **Pricing:** $0.000000455/1M prompt, $N/A/1M completion
...
- **Context:** 262,144 tokens
- **Pricing:** $0.000000071/1M prompt, $N/A/1M completion
...
- **Context:** 1,000,000 tokens
- **Pricing:** $0.000000195/1M prompt, $N/A/1M completion
...
- **ID:** `qwen/qwen3-max`
- **Context:** 262,144 tokens
- **Pricing:** $0.00000078/1M prompt, $N/A/1M completion
...
- **Context:** 256,000 tokens
- **Pricing:** $0.00000085/1M prompt, $N/A/1M completion
...
- **Context:** 8,192 tokens
- **Pricing:** $0.00000148/1M prompt, $N/A/1M completion
- **Description:** Euryale 70B v2.1 is a model focused on creative roleplay from [Sao10k](https://ko-fi.com/sao10k). - Better prompt adherence. - Better anatomy / spatial awareness. - Adapts much better to unique and cu...
...
- **Context:** 32,768 tokens
- **Pricing:** $0.00000017/1M prompt, $N/A/1M completion
- **Description:** Rocinante 12B is designed for engaging storytelling and rich prose. Early testers have reported: - Expanded vocabulary with unique and expressive word choices - Enhanced creativity for vivid narrative...

#### TheDrummer: Skyfall 36B V2
- **ID:** `thedrummer/skyfall-36b-v2`
- **Context:** 32,768 tokens
- **Pricing:** $0.00000055/1M prompt, $N/A/1M completion
...
- **Pricing:** $0.00000045/1M prompt, $N/A/1M completion
...
- **Context:** 2,000,000 tokens
- **Pricing:** $0.000002/1M prompt, $N/A/1M completion
- **Description:** Grok 4.20 Multi-Agent is a variant of xAI’s Grok 4.20 designed for collaborative, agent-based workflows. Multiple agents operate in parallel to conduct deep research, coordinate tool use, and synthesi...
...
- **Context:** 262,144 tokens
- **Pricing:** $0.0000004/1M prompt, $N/A/1M completion
- **Description:** MiMo-V2-Omni is a frontier omni-modal model that natively processes image, video, and audio inputs within a unified architecture. It combines strong multimodal perception with agentic capability - vis...

#### Xiaomi: MiMo-V2-Pro
- **ID:** `xiaomi/mimo-v2-pro`
- **Context:** 1,048,576 tokens
- **Pricing:** $0.000001/1M prompt, $N/A/1M completion
- **Description:** MiMo-V2-Pro is Xiaomi's flagship foundation model, featuring over 1T total parameters and a 1M context length, deeply optimized for agentic scenarios. It is highly adaptable to general agent framework...
...
- **Context:** 128,000 tokens
- **Pricing:** $0.0000001/1M prompt, $N/A/1M completion
- **Description:** GLM 4 32B is a cost-effective foundation language model. It can efficiently perform complex tasks and has significantly enhanced capabilities in tool use, online search, and code-related intelligent t...
...
### Best for Cost
- Look for models with lowest pricing per million tokens

### Best for Quality
- Claude Opus 4.5, GPT-4o, Gemini Pro

### Best for Speed
- Claude Haiku, GPT-4o-mini, Gemini Flash

### Best for Long Context
- Sort by context_length for models with 100k+ tokens
