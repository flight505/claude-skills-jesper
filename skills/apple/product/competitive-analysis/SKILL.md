...
```json
{
  "competitors": [
    {
      ...
      "unique_features": ["Feature only they have"],
      "strengths": ["What they do well"],
      "weaknesses": ["What they lack or do poorly"],
  ...
  "feature_gaps": ["Feature nobody offers well", "Feature with poor implementation across board"],
  "pricing_insights": {
    "average_price": "$X",
    "pricing_range": "$Y - $Z",
